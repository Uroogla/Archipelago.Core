...
namespace Archipelago.Core.Util.PCSX2
{
    internal class PCSX2MemoryHelper
    {
        ...
        public IntPtr FindEEromAddress()
        {
            ...
            IntPtr pcsx2Module = FindModuleInProcess("pcsx2-qt");
            if (pcsx2Module == IntPtr.Zero)
            {
                Console.WriteLine("Failed to find PCSX2 module");
                return IntPtr.Zero;
            }

            // Find the export table in the PE header
            IntPtr exportTableAddress = FindExportTable(pcsx2Module);
            ...
            IntPtr EEmemPtr = FindExportByName(pcsx2Module, exportTableAddress, "EEmem");
        ...
        private IntPtr FindModuleInProcess(string moduleName)
        {
            ...
            IntPtr snapshot = CreateToolhelp32Snapshot(0x00000008, Memory.GetProcIdFromExe("pcsx2-qt"));
